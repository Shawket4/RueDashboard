      ...
      {payload.map((p: any) => (
        ...
        >
          ...
          <span className="font-bold text-xs tabular-nums">
            {p.dataKey.includes("revenue") || p.dataKey === "revenue"
              ? egp(p.value)
              : p.value}
          </span>
        </div>
...
export default function Analytics() {
  ...
  const branchCols: ColumnDef<BranchComparison, any>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <span
          className={`tabular-nums text-xs ${row.original.void_rate_pct > 5 ? "text-red-500 font-semibold" : "text-muted-foreground"}`}
        >
                ...
                <AreaChart data={tsData}>
                  <defs>
                    ...
                    >
                      <stop
                        offset="5%"
                        stopColor={PAYMENT_COLORS.talabat_online}
                        stopOpacity={0.3}
                      />
                      <stop
                        offset="95%"
                    ...
                    >
                      <stop
                        offset="5%"
                        stopColor={PAYMENT_COLORS.talabat_cash}
                        stopOpacity={0.3}
                      />
                      <stop
                        offset="95%"
